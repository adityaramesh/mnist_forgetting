...
require "source/utility/run_model_mnist_half"
...
function options_func(cmd)
	...
	cmd:option("-model_file", "source/models/cnn_5x5_mnist_half.lua", "Path to file that defines model architecture.")
	cmd:option("-zero_half", 1, "Which half of the gradients to mask (1 or 2).")
end
...
run_model(get_task_info, load_model_info, get_train_info, options_func)
